...
//        if(m_spectatorButton != null)
//        {
//            m_spectatorButton.onClick.AddListener(() => SelectColor(ChessGameManager.EChessTeam.Spectator));
//        }
//    }
...
//        if(team == ChessGameManager.EChessTeam.Spectator)
//        {
//            Debug.Log("[GUIManager] Spectator mode, no team message will be sent.");
//            ChessGameManager.Instance.StartNetworkGame(ChessGameManager.EChessTeam.Spectator);
//            return;
//        }
...
public class GUIManager : MonoBehaviour
{
    ...
    private void SelectColor(ChessGameManager.EChessTeam team)
    {
        ...
        if (team == ChessGameManager.EChessTeam.Spectator)
        {
            Debug.Log("[GUIManager] Spectator mode selected. No TEAM message will be sent.");
            ChessGameManager.Instance.StartNetworkGame(ChessGameManager.EChessTeam.Spectator);
            return;
        }
    ...
    public void DisableTeamButton(string team)
    {
        if (team == "White")
        {
            m_whiteButton.interactable = false;
        }
        if (team == "Black")
        {
